...
class _SettingsViewState extends State<SettingsView> {
    ...
    return Align(
      ...
      child: ConstrainedBox(
        ...
        child: SingleChildScrollView(
          ...
          _buildUpdateSection(appProvider, theme),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Daily Health Update Reminder',
                      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                  const SizedBox(height: 2),
                  Text(
            ...
            if (s.healthReminderEnabled) ...[
              ...
              Builder(builder: (ctx) => OutlinedButton.icon(
                icon: Icon(MdiIcons.clockOutline, size: 16),
                label: Text('Change Time — ${fmtTime(s.healthReminderHour, s.healthReminderMinute)}'),
                onPressed: () => pickTime(
                  ctx,
  ...
  Widget _buildUpdateSection(AppProvider appProvider, ThemeData theme) {
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: Text(
                appProvider.isCheckingUpdate ? 'CHECKING GITHUB BUILDS...' : 'CHECK FOR UPDATES NOW',
