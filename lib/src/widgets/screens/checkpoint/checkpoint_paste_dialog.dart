...
class CheckpointPasteDialog {
  static void show({
    required BuildContext context,
    required String title,
    required ValueChanged<String> onImport,
  }) {
        ...
        content: Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(color: JweTheme.textMid, fontSize: 12),
            ),
  ...
  static void handlePaste({
    ...
    required SubSubTask liveCheckpoint,
  }) {
    show(
      context: context,
      title: "PASTE NESTED OBJECTIVE",
      onImport: (pastedText) {
