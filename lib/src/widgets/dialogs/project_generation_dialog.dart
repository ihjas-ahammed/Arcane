...
class ProjectGenerationDialog extends StatefulWidget {
  ...
  @override
  State<ProjectGenerationDialog> createState() =>
      _ProjectGenerationDialogState();
}
...
class _ProjectGenerationDialogState extends State<ProjectGenerationDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: const Text("Generate Project with AI",
          style: TextStyle(color: AppTheme.fhTextPrimary)),
      content: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Text(
              "Describe the project goal. The AI will break it down into recursive steps.",
          ...
          TextField(
            ...
            decoration: const InputDecoration(
                hintText:
                    "e.g., Build a personal website with portfolio and blog.",
              ...
              : () async {
                  if (_promptController.text.isNotEmpty) {
                    ...
                    provider.projectActions
                        .generateProjectStructure(widget.mainTaskId, prompt);
                  }
                },
