...
class TacticalBriefingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (rawSops is List && rawSops.isNotEmpty) {
      ...
      suggestedSops = _generateFallbackSuggestedSops(briefingData);
    }
  ...
  static List<Map<String, String>> _generateFallbackSuggestedSops(Map<String, dynamic> data) {
