Make the following changes:
    ...
    - Fix:
        - As for recurring tasks, dont delete the entire session data while we reset them everyday, keep the sessiondata and only reset the checkpoints ticks

* Add the above feature still sticking with VALORANT protocol theme
